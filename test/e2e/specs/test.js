...
module.exports = {
  ...
  'test menu': function ( browser ) {
    browser
      ...
      .expect.element( '#app > div.application--wrap > aside > ul > li:nth-child(4)' ).to.be.present;
  },
  ...
  'test card count': function ( browser ) {
    browser
      ...
      .expect.element( '#app > div.application--wrap > div > main > div.container.fluid.fill-height > div > div > div.layout.row.wrap > div:nth-child(6)' ).to.be.present;

    browser
      .expect.element( '#app > div.application--wrap > div > main > div.container.fluid.fill-height > div > div > div.layout.row.wrap > div:nth-child(7)' ).to.not.be.present;
  },
