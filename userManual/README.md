...
![Add Slide Button](slidesSnapshots/addSlide.PNG)

#### *What does the content of the page look like?*
![Designer Page](designerSnapshots/page.PNG)
...
![Title of Event](designerSnapshots/title.PNG)
* Description of Event

![Description of Event](designerSnapshots/desc.PNG)
* Photos (although this field does not have an asterisk it is a required field)

![Description of Event](designerSnapshots/photos.PNG)
...
![Clear](designerSnapshots/clear.PNG)
...
![Down Arrow](designerSnapshots/downArrow.PNG)

![Customize](designerSnapshots/customize.PNG)

And once everything is set, it can look.... Cool?

![Customized Design](designerSnapshots/customized.PNG)
...
![Slide Settings](designerSnapshots/slideSettings.PNG)
...
![Duration](designerSnapshots/displaySeconds.PNG)
* Wait, another Duration?

![Duration 2](designerSnapshots/durationTemplate.PNG)
...
![New Week](foodMenuSnapshots/emptyWeek.PNG)
...
![Add Week](foodMenuSnapshots/addWeek.PNG)
...
![Add Food](foodMenuSnapshots/enterFood.PNG)

Similarly, to remove food, erase it from the text field.

![Remove Food](foodMenuSnapshots/removeFood.PNG)
...
![Save Icon](foodMenuSnapshots/saveMenu.PNG)

So you may have noticed that there was a button that resembled a calendar? 

![Calendar Button](foodMenuSnapshots/calendar.PNG)
