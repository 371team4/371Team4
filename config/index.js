...
// get the browser command, specifically google chrome
const browserCommand = getBrowserCommand()

// return browser command for the given operating system
...
module.exports = {
  dev: {
    ...
    host: 'galliumos', // can be overwritten by process.env.HOST
    port: 8080, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
    autoOpenBrowser: browserCommand,
    errorOverlay: true,
    notifyOnErrors: true,
